...
export default function CactusBloomDeveloped({
  width,
  height,
  bgTop = '#1F3A2A',
  bgBottom = '#2A4A35',
  ...
  return (
    ...
    >
      ...
      <Rect x="318" y="200" width="44" height="290" rx="22" fill="#5A8A40" />
      {/* Spines */}
      <Circle cx="322" cy="215" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="228" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="322" cy="250" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="268" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="322" cy="290" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="310" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="322" cy="335" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="355" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="322" cy="380" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="400" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="322" cy="425" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="358" cy="448" r="3" fill="#8DC468" opacity="0.6" />

      {/* Left arm — long */}
      <Path d="M318 330 Q255 325 248 278 Q243 245 268 238" fill="none" stroke="#5A8A40" strokeWidth="32" strokeLinecap="round" />
      <Circle cx="250" cy="276" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="269" cy="239" r="3" fill="#8DC468" opacity="0.6" />
      {/* Small bloom on left arm tip */}
      <Circle cx="268" cy="230" r="10" fill="#E8A0C0" />
      <Circle cx="268" cy="230" r="5" fill="#F4C430" />

      {/* Right arm — long */}
      <Path d="M362 360 Q425 354 432 307 Q437 274 412 267" fill="none" stroke="#5A8A40" strokeWidth="28" strokeLinecap="round" />
      <Circle cx="430" cy="305" r="3" fill="#8DC468" opacity="0.6" />
      <Circle cx="411" cy="268" r="3" fill="#8DC468" opacity="0.6" />
      {/* Small bloom on right arm tip */}
      <Circle cx="411" cy="258" r="10" fill="#E8A0C0" />
      <Circle cx="411" cy="258" r="5" fill="#F4C430" />

      {/* Second left arm — higher */}
      <Path d="M318 260 Q278 255 274 228 Q271 210 286 206" fill="none" stroke="#5A8A40" strokeWidth="22" strokeLinecap="round" />

      {/* Full bloom on top */}
      <Circle cx="340" cy="188" r="28" fill="#E8A0C0" />
      <Circle cx="340" cy="188" r="14" fill="#F4C430" />
      {/* Full petals */}
      <Ellipse cx="340" cy="158" rx="9" ry="16" fill="#E8A0C0" opacity="0.9" />
      <Ellipse cx="340" cy="218" rx="9" ry="16" fill="#E8A0C0" opacity="0.9" />
      <Ellipse cx="310" cy="188" rx="16" ry="9" fill="#E8A0C0" opacity="0.9" />
      <Ellipse cx="370" cy="188" rx="16" ry="9" fill="#E8A0C0" opacity="0.9" />
      <Ellipse cx="319" cy="167" rx="9" ry="16" fill="#E8A0C0" opacity="0.85" transform="rotate(-45 319 167)" />
      <Ellipse cx="361" cy="167" rx="9" ry="16" fill="#E8A0C0" opacity="0.85" transform="rotate(45 361 167)" />
      <Ellipse cx="319" cy="209" rx="9" ry="16" fill="#E8A0C0" opacity="0.85" transform="rotate(45 319 209)" />
      <Ellipse cx="361" cy="209" rx="9" ry="16" fill="#E8A0C0" opacity="0.85" transform="rotate(-45 361 209)" />

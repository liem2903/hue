...
export default function CactusBloomSeedling({
  width,
  height,
  bgTop = '#1F3A2A',
  bgBottom = '#2A4A35',
  ...
  return (
    ...
    >
      ...
      {/* Main pot */}
        <Path d="M 200 480 L 250 700 L 430 700 L 480 480 Z" fill={potColor} />
        <Rect x="192" y="466" width="296" height="28" rx="4" fill={potRim} />
        <Ellipse cx="340" cy="480" rx="148" ry="11" fill={shelfColor} opacity="0.5" />

        {/* Soil */}
        <Ellipse cx="340" cy="483" rx="136" ry="10" fill={soilColor} />
        <Ellipse cx="315" cy="479" rx="28" ry="5" fill="#2A1A0F" opacity="0.7" />
        <Ellipse cx="370" cy="481" rx="20" ry="4" fill="#2A1A0F" opacity="0.5" />

      {/* Baby cactus — bigger */}
      {/* Main stem */}
      <Rect x="326" y="370" width="28" height="108" rx="14" fill="#5A8A40" />
      {/* Spines */}
      <Circle cx="330" cy="385" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="350" cy="393" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="330" cy="408" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="350" cy="418" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="330" cy="433" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="350" cy="445" r="2" fill="#8DC468" opacity="0.6" />
      {/* Left arm */}
      <Path d="M326 405 Q296 400 294 378 Q293 365 306 364" fill="none" stroke="#5A8A40" strokeWidth="20" strokeLinecap="round" />
      <Circle cx="296" cy="378" r="2" fill="#8DC468" opacity="0.6" />
      <Circle cx="307" cy="365" r="2" fill="#8DC468" opacity="0.6" />
      {/* Flower bud on top */}
      <Circle cx="340" cy="362" r="12" fill="#E8A0C0" />
      <Circle cx="340" cy="362" r="6" fill="#F4C430" />

...
export default function ClimbingVineSeedling({
  width, height,
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 680 1000" preserveAspectRatio="xMidYMid meet" style={{ position: 'absolute', top: 0, left: 0 }}>
      ...
      {/* Climbing vine seedling — small curling tendril */}
      <Path d="M340 480 Q345 430 360 420 Q380 415 378 395" fill="none" stroke="#4A8A50" strokeWidth="5" strokeLinecap="round" />
      <Path d="M378 395 Q372 388 376 380" fill="none" stroke="#4A8A50" strokeWidth="4" strokeLinecap="round" />
      {/* Two small heart-shaped leaves */}
      <Path d="M360 430 Q345 425 348 440 Q355 445 360 430Z" fill="#6AB060" />
      <Path d="M375 410 Q388 405 388 420 Q380 425 375 410Z" fill="#6AB060" />
      <Path d="M360 430 L348 440" stroke="#3A7040" strokeWidth="0.8" />
      <Path d="M375 410 L388 420" stroke="#3A7040" strokeWidth="0.8" />

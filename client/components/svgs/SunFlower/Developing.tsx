...
export default function SunflowerDeveloping({
  width, height,
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 680 1000" preserveAspectRatio="xMidYMid meet" style={{ position: 'absolute', top: 0, left: 0 }}>
      ...
      {/* Tall stem */}
      <Rect x="336" y="290" width="8" height="190" rx="3" fill="#6AA050" />
      {/* Leaves along stem */}
      <Ellipse cx="305" cy="400" rx="28" ry="14" fill="#7AB560" transform="rotate(-20 305 400)" />
      <Ellipse cx="375" cy="370" rx="28" ry="14" fill="#7AB560" transform="rotate(20 375 370)" />
      <Ellipse cx="305" cy="340" rx="24" ry="12" fill="#8DC468" transform="rotate(-20 305 340)" />
      <Path d="M305 400 L335 405" stroke="#5A8A40" strokeWidth="0.8" />
      <Path d="M375 370 L345 375" stroke="#5A8A40" strokeWidth="0.8" />

      {/* Closed bud */}
      <Circle cx="340" cy="285" r="22" fill="#8DC468" />
      <Circle cx="340" cy="285" r="14" fill="#5A8A40" />
      {/* Petals starting to show */}
      <Ellipse cx="340" cy="265" rx="6" ry="12" fill="#F4C430" opacity="0.7" />
      <Ellipse cx="320" cy="278" rx="6" ry="12" fill="#F4C430" opacity="0.7" transform="rotate(-50 320 278)" />
      <Ellipse cx="360" cy="278" rx="6" ry="12" fill="#F4C430" opacity="0.7" transform="rotate(50 360 278)" />

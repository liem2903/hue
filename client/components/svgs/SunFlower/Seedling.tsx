...
export default function SunflowerSeedling({
  width, height,
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 680 1000" preserveAspectRatio="xMidYMid meet" style={{ position: 'absolute', top: 0, left: 0 }}>
      ...
      {/* Tiny sunflower seedling — stem with two cotyledon leaves */}
      <Rect x="338" y="430" width="4" height="50" rx="2" fill="#6AA050" />
      <Ellipse cx="322" cy="438" rx="14" ry="8" fill="#7AB560" transform="rotate(-25 322 438)" />
      <Ellipse cx="358" cy="438" rx="14" ry="8" fill="#7AB560" transform="rotate(25 358 438)" />
      {/* Tiny bud */}
      <Circle cx="340" cy="425" r="4" fill="#8DC468" />

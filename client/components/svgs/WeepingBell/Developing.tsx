...
export default function WeepingBellDeveloping({
  width, height,
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 680 1000" preserveAspectRatio="xMidYMid meet" style={{ position: 'absolute', top: 0, left: 0 }}>
      ...
      {/* Tall arched stem */}
      <Path d="M340 480 Q345 380 320 340 Q295 320 280 335" fill="none" stroke="#5A8A50" strokeWidth="7" strokeLinecap="round" />
      <Path d="M340 480 Q330 410 355 370 Q380 355 395 370" fill="none" stroke="#5A8A50" strokeWidth="7" strokeLinecap="round" />

      {/* Leaves along stems */}
      <Ellipse cx="335" cy="445" rx="14" ry="7" fill="#7AB560" transform="rotate(-15 335 445)" />
      <Ellipse cx="350" cy="430" rx="14" ry="7" fill="#7AB560" transform="rotate(20 350 430)" />
      <Ellipse cx="320" cy="395" rx="12" ry="6" fill="#7AB560" transform="rotate(-25 320 395)" />
      <Ellipse cx="365" cy="395" rx="12" ry="6" fill="#7AB560" transform="rotate(25 365 395)" />

      {/* Hanging bells */}
      <Path d="M276 335 Q270 350 282 352 Q288 350 286 336Z" fill="#9070B8" />
      <Ellipse cx="281" cy="352" rx="4" ry="2" fill="#7A5AA0" />
      <Path d="M392 370 Q386 385 398 387 Q404 385 402 371Z" fill="#9070B8" />
      <Ellipse cx="397" cy="387" rx="4" ry="2" fill="#7A5AA0" />
